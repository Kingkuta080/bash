    ...
    >
      <div className="w-full max-w-5xl mx-auto">
        ...
        <div className="relative">
          {/* Navigation Buttons */}
          <button
            className="absolute left-[-4rem] text-white top-1/2 -translate-y-1/2 bg-cyan-400 text-black rounded-full w-10 h-10 flex items-center justify-center shadow-lg z-10 focus:outline-none focus:ring-2 focus:ring-cyan-400"
          ...
          <button
            className="absolute right-[-4rem] text-white top-1/2 -translate-y-1/2 bg-cyan-400 text-black rounded-full w-10 h-10 flex items-center justify-center shadow-lg z-10 focus:outline-none focus:ring-2 focus:ring-cyan-400"
